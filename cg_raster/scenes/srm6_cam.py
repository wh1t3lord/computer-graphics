...
class SceneRasterMaterialBPColorBasedCamera(core.IScene):
    def __init__(self):
        ...
        self.ui_cpu_light_ambient_intensity_diffuse = None
        self.ui_cpu_light_ambient_intensity_specular = None
    ...
    def _init(
        ...
        if self.device:
            ...
            if ui_main_window != None:
                ...
                self.ui_cpu_light_ambient_intensity_ambient = spy.ui.DragFloat3(
                    ui_main_window,
                    'ambient light intensity ambient',
                    self.light_ambient.intensity_ambient,
                    self._ui_set_dragfloat3_light_ambient_intensity_ambient,
                    0.01,
                    0.0,
                    1.0
                )

                self.ui_cpu_light_ambient_intensity_diffuse = spy.ui.DragFloat3(
                    ui_main_window,
                    'ambient light intensity diffuse',
                    self.light_ambient.intensity_diffuse,
                    self._ui_set_dragfloat3_light_ambient_intensity_diffuse,
                    0.01,
                    0.0,
                    1.0
                )

                self.ui_cpu_light_ambient_intensity_specular = spy.ui.DragFloat3(
                    ui_main_window,
    ...
    def _ui_set_dragfloat3_light_ambient_intensity_ambient(self, value):
        self.light_ambient.intensity_ambient = value

    def _ui_set_dragfloat3_light_ambient_intensity_diffuse(self, value):
        self.light_ambient.intensity_diffuse = value

    def _ui_set_dragfloat3_light_ambient_intensity_specular(self, value):
        self.light_ambient.intensity_specular = value
         ...
         #   command_encoder.clear_texture_float(texture_surface, clear_value=[0,0,0,1])
            ...
            with command_encoder.begin_render_pass(
                ...
                cursor.g_lightAmbient = {
                    "intensity_ambient": self.light_ambient.intensity_ambient,
                    "intensity_diffuse": self.light_ambient.intensity_diffuse,
                    "intensity_specular": self.light_ambient.intensity_specular,
