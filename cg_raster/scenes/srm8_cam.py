...
class SceneRasterDirectionalLightCamera(core.IScene):
    def __init__(self):
        super().__init__()
        ...
        self.ui_cpu_light_direction_intensity_ambient = None
        self.ui_cpu_light_direction_intensity_diffuse = None
        self.ui_cpu_light_direction_intensity_specular = None
        self.ui_cpu_light_direction = None
    ...
    def _init(
        ...
        if self.device:
            ...
            self.light_directional = core.LightDirectionalBlinnPhong()
            self.light_directional.direction = [0.160, -0.06, 0.09]
            self.light_directional.intensity_ambient = [0.0, 0.0, 0.0]
            ...
            self.model_light.vPosition = [0.0, 50.0, 0.0]
            ...
            if ui_main_window != None:
                ...
                self.ui_cpu_light_direction = spy.ui.DragFloat3(
                    ui_main_window,
                    'directional light direction',
                    self.light_directional.direction,
                    self._ui_set_dragfloat3_directional_light_direction,
                    0.01,
                    -100.0,
                    100.0
                )
                ...
                self.ui_cpu_light_direction_intensity_ambient = spy.ui.DragFloat3(
                    ui_main_window,
                    'directional light intensity ambient',
                    self.light_directional.intensity_ambient,
                    self._ui_set_dragfloat3_light_directional_intensity_ambient,
                    0.01,
                    0.0,
                    1.0
                )
                ...
                self.ui_cpu_light_direction_intensity_diffuse = spy.ui.DragFloat3(
                    ui_main_window,
                    'directional light intensity diffuse',
                    self.light_directional.intensity_diffuse,
                    self._ui_set_dragfloat3_light_directional_intensity_diffuse,
                    0.01,
                    0.0,
                    1.0
                )
                ...
                self.ui_cpu_light_direction_intensity_specular = spy.ui.DragFloat3(
                    ui_main_window,
                    'directional light intensity specular',
                    self.light_directional.intensity_specular,
                    self._ui_set_dragfloat3_light_directional_intensity_specular,
                    0.01,
                    0.0,
                    1.0
                )
    ...
    def _ui_set_dragfloat3_directional_light_direction(self, value):
        self.light_directional.direction = value

    def _ui_set_dragfloat3_light_directional_intensity_ambient(self, value):
        self.light_directional.intensity_ambient = value

    def _ui_set_dragfloat3_light_directional_intensity_diffuse(self, value):
        self.light_directional.intensity_diffuse = value

    def _ui_set_dragfloat3_light_directional_intensity_specular(self, value):
        self.light_directional.intensity_specular = value
